...
if(isset($_POST['id'])) {
    $query = "UPDATE responsaveis set nome = '$nome', nacionalidade='$nacionalidade', nascimento='$nascimento', rg='$rg', cpf='$cpf', relacionamento='$relacionamento', email='$email', endereco='$endereco', cep='$cep', telefone='$telefone', unidade_id=$unidade where id='$id';";   
    ...
    foreach ($nome_aluno as $key => $value) {
        $query = "INSERT INTO alunos(nome, serie, nascimento, restricao, responsavel_id) VALUES ('$value', '$serie_aluno[$i]', '$nascimento_aluno[$i]', '$restricao_aluno[$i]', $responsavel_id)";      
